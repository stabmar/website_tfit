...
<div id="actions_required" class="zerif-pro-tab-pane">

    <h1><?php printf( __('Keep up with %1$s\'s latest news' ,'zerif' ), 'Zerif PRO' ); ?></h1>
	...
	if( $nr_actions_required == 0 ):
		echo '<p>'.__( 'Hooray! There are no required actions for you right now.','zerif' ).'</p>';
	endif;
	?>
